-- =====================================================
-- Minimal Idempotent Migration: Insert Prompts Only
-- =====================================================
-- This script safely inserts the 3 required prompts
-- Can be run multiple times without errors
-- =====================================================

-- Insert prompts with ON CONFLICT DO NOTHING (idempotent)
